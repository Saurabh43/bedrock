...
;(function($, Mozilla) {
    ...
    function trackGAConversationConnect() {
        gaTrack(['_trackEvent', 'hello interactions', 'all', 'TourConnectConversation']);
    }
        ...
        Mozilla.UITour.observe(function(event, data) {
            ...
            case 'Loop:ChatWindowOpened':
                ...
                if (tourStep === 'get-started') {
                    ...
                    // TODO track snippet & product page referrers
                    gaTrack(['_trackEvent', 'hello interactions', 'direct', 'StartConversation-Tour']);
            ...
            case 'Loop:RoomURLCopied':
                ...
                // TODO track snippet & product page referrers
                gaTrack(['_trackEvent', 'hello interactions', 'direct', 'CopyLink-Tour']);
                break;
            }
